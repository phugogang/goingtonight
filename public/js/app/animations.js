...
export var itemStateTrigger = trigger('itemState', [
    transition(':enter', [
...
export var searchStateTrigger = trigger('searchState', [
    transition(':enter', [
        animate('1s ease-out', keyframes([
            style({
                opacity: 0,
...
export var routeFadeStateTrigger = trigger('routeFadeState', [
    transition(':enter', [
        style({
            opacity: 0
        }),
...
export var routeSlideStateTrigger = trigger('routeSlideState', [
    transition(':enter', [
        style({
            transform: 'translateY(-100%)'
        }),
...
export var buttonStateTrigger = trigger('buttonState', [
